...
<head>
    ...
    <script src="../../js/embroidery.js" ></script>
...
<form:form method="post" action="/infodetail" modelAttribute="tableForm">
    <div class="table-responsive">
        <table class="table table-bordered" style="width: 1400px;">
            ...
            <tr>
                ...
                <form:input type="text" path="orderTable.preWeight" readonly="true" hidden="true"/>
                <form:input type="text" path="orderTable.afterWeight" readonly="true" hidden="true"/>
            </tr>
            <tr>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 p-0">
                                        <form:input type="text" path="productList[${status.index}].id" readonly="true"
                                                    hidden="true"/>
                                        <form:input type="text" path="productList[${status.index}].tableId"
                                                    readonly="true"
                                                    hidden="true"/>
                                    ...
                                    <div class="col-sm-1 p-0">
                                        <a class="btn-danger btn-xs"
                                           href="product/${prod.tableId}/delete/${prod.id}">-</a>
                                    </div>
                                </div>
                                <br>
                            </c:forEach>
                        ...
                        <c:if test="${tableForm.printerList.size() > 0}">
                            <c:forEach items="${tableForm.printerList}" var="print" varStatus="status">
                                <div class="row">
                                    ...
                                    <div class="col-sm-1 p-0">
                                        <a class="btn-danger btn-xs"
                                           href="printer/${print.tableId}/delete/${print.id}">-</a>
                                    </div>
                                </div>
                                <br>
                            </c:forEach>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 p-0">
                                        <form:input type="text" path="embroideryList[${status.index}].id"
                                                    readonly="true" hidden="true"/>
                                        <form:input type="text" path="embroideryList[${status.index}].tableId"
                                                    readonly="true" hidden="true"/>
                                        <form:select path="embroideryList[${status.index}].name">
                                            <c:forEach items="${tableForm.teamList}" var="team">
                                                <c:if test="${team.teamId == 2}">
                                                    <form:option value="${team.name}">${team.name}</form:option>
                                                </c:if>
                                            </c:forEach>
                                        </form:select>
                                    ...
                                    <div class="col-sm-1 p-0">
                                        <a class="btn-danger btn-xs"
                                           href="embroidery/${embroid.tableId}/delete/${embroid.id}">-</a>
                                    </div>
                                </div>
                                <br>
                            </c:forEach>
                                ...
                                <div class="row">
                                    <div class="col-sm-4 p-0">
                                        <form:input type="text" path="sewingList[${status.index}].id" readonly="true"
                                                    hidden="true"/>
                                        <form:input type="text" path="sewingList[${status.index}].tableId"
                                                    readonly="true" hidden="true"/>
                                        <form:select path="sewingList[${status.index}].name">
                                            <c:forEach items="${tableForm.teamList}" var="team">
                                                <c:if test="${team.teamId == 3}">
                                                    <form:option value="${team.name}">${team.name}</form:option>
                                                </c:if>
                                            </c:forEach>
                                        </form:select>
                                    ...
                                    <div class="col-sm-1 p-0">
                                        <a class="btn-danger btn-xs"
                                           href="sewing/${sew.tableId}/delete/${sew.id}">-</a>
                                    </div>
                                </div>
                                <br>
                            </c:forEach>
                                ...
                                <div class="row">
                                    <div class="col-sm-3 p-0">
                                        <form:input type="text" path="materialList[${status.index}].id" readonly="true"
                                                    hidden="true"/>
                                        <form:input type="text" path="materialList[${status.index}].tableId"
                                                    readonly="true" hidden="true"/>
                                    ...
                                    <div class="col-sm-2 p-0">
                                        <form:input type="text" path="materialList[${status.index}].numClass"/>
                                    </div>
                                    <div class="col-sm-3 p-0">
                                        <form:input type="text" path="materialList[${status.index}].quantity"/>
                                    </div>
                                    <div class="col-sm-1 p-0">
                                        <a class="btn-danger btn-xs" href="material/${mate.tableId}/delete/${mate.id}">-</a>
                                    </div>
                                </div>
                                <br>
                            </c:forEach>
                ...
                <div class="container-fluid">
                    <c:forEach items="${tabform.materialList}" var="material">
                        <div class="row" style="border: 1px dashed darkgrey">
                            ...
                            <div class="col-sm-3">${material.numClass}</div>
