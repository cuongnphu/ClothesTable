    ...
    public @ResponseBody StatisticForm getStatisticByParam(String name, int team_id) {
        ...
        if(team_id == 1){
            ...
            for(int i = 0 ; i < printerList.size(); i++){
                OrderTable orderTab = this.orderTableService.getOrderTableById(printerList.get(i).getTableId());
            ...
            for(int i = 0 ; i < embroideryList.size(); i++){
                OrderTable orderTab = this.orderTableService.getOrderTableById(embroideryList.get(i).getTableId());
                orderTableList.add(orderTab);
            }
            ...
            for(int i = 0 ; i < sewingList.size(); i++){
                OrderTable orderTab = this.orderTableService.getOrderTableById(sewingList.get(i).getTableId());
                orderTableList.add(orderTab);
            }
