...
function addMaterial(tabId,intIndex) {
    ...
    inputtableid.id = "materialList"+index+".tableId";
    inputtableid.type = "text";
    inputtableid.name = "materialList["+index+"].tableId";
    ...
    // Initialize variable NumClass
    var inputNumClass = document.createElement("input");
    inputNumClass.id = "materialList"+index+".numClass";
    inputNumClass.type = "text";
    inputNumClass.name = "materialList["+index+"].numClass";
