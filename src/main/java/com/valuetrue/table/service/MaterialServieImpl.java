...
public class MaterialServieImpl implements MaterialServie {
    ...
    public void saveMaterial(Material material) {
        if (material.getName() != "" && material.getWeight() != null && material.getNumClass() != null && material.getQuantity() != null)
            if (material.getWeight() > 0 && material.getNumClass() > 0 && material.getQuantity() > 0)
