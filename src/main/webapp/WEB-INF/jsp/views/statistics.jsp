    ...
    <div class="table-responsive">
        <table class="table table-bordered" style="width: 900px">
            ...
            <tr>
                <td>Ngành Nghề :</td>
                <td>
                    <form:select path="teamList[0].teamId">
                        <c:if test="${tableForm.teamList.get(0).teamId == 1}">
            ...
            <tr>
                <td><a class="btn btn-info" onclick="window.location.replace('/detailtable')">&#10094 Thông
...
<table class="table table-bordered" style="width: 1100px">
    <thead class="thead">
    <tr>
        <th style="width: 17%">Tên Đội</th>
        <th style="width:8%">Ngành</th>
        <th style="width: 55%">
